    ...
    <div class="bg-white rounded-lg shadow-lg p-8 w-1/3 max-w-md">
        ...
        <form id="editForm" action="{{ route('data.update', ':id') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="tahun" id="tahun" step="0.01" required class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#CEAB93] focus:border-transparent transition-all duration-300">
            </div>
